...
/**
 * Defines the {@code Conhecatour} Sling Model used for the {@code cryptobike/components/conhecatour} component.
 * 
 */
@ConsumerType
public interface Conhecatour
    extends ComponentExporter
{


    String getTitleconhecatour();

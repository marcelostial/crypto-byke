...
const LazyTextComponent = withAsyncImport(() =>import(`./components/Text/Text`));
...
MapTo("cryptobike/components/download")(DownloadV1, {isEmpty: DownloadV1IsEmptyFn,});
MapTo("cryptobike/components/carousel")(CarouselV1, {isEmpty: CarouselV1IsEmptyFn,});
MapTo("cryptobike/components/separator")(SeparatorV1, {isEmpty: SeparatorV1IsEmptyFn,});
MapTo("cryptobike/components/accordion")(AccordionV1, {isEmpty: AccordionV1IsEmptyFn,});
MapTo("cryptobike/components/container")(ContainerV1, {isEmpty: ContainerV1IsEmptyFn,});
MapTo("cryptobike/components/breadcrumb")(BreadCrumbV2, {isEmpty: BreadCrumbV2IsEmptyFn,});
